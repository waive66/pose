...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        model = YOLO("model1.pt")  # load a pretrained model (recommended for training)
    ...
    3. Use the command line interface (CLI):
        ...
        - Train a detection model for 10 epochs with an initial learning_rate of 0.01
            yolo detect train data=coco8.yaml model=model1.pt epochs=10 lr0=0.01

        - Predict a YouTube video using a pretrained segmentation model at image size 320:
            yolo segment predict model=model3.pt source='https://youtu.be/LNwODJXcvt4' imgsz=320

        - Val a pretrained detection model at batch-size 1 and image size 640:
            yolo detect val model=model1.pt data=coco8.yaml batch=1 imgsz=640
