...
class Model(nn.Module):
    ...
    def __init__(
        self,
        model: Union[str, Path] = "model1.pt",
        task: str = None,
        verbose: bool = False,
    ) -> None:
        """
    ...
    def is_triton_model(model: str) -> bool:
        ...
        Examples:
            ...
            True
            >>> Model.is_triton_model("model1.pt")
            False
        """
    ...
    def load(self, weights: Union[str, Path] = "model1.pt") -> "Model":
        """
